...
<title><spring:message
		code="koty-webapp.KotyController.lista.title" /></title>
</head>
<body>
	...
	<br />
	<br />
	<a href="dodaj"><spring:message
			code="koty-webapp.KotyController.lista.add" /></a>
	<br />
	<table border="1">
		<thead>
			<tr>
				<th>#</th>
				<th><spring:message
						code="koty-webapp.KotyController.lista.name" /></th>
			</tr>
		</thead>
		<tbody>
	...
	<c:if test="${pageContext.request.userPrincipal.name != null}">
		<h2>${pageContext.request.userPrincipal.name}
			| <a href="javascript:formSubmit()"> <spring:message
						code="koty-webapp.KotyController.lista.logout" /></a>
		</h2>
	</c:if>
